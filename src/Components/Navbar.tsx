  ...
  return (
    ...
    >
      <nav className="w-screen  mx-auto flex justify-between h-20 items-center md:px-12 px-4">
        <div className="flex items-center justify-between  w-full ">
          <div className="flex items-center">
            <Image
              ...
              height={100}
              width={100}
              className="mt-4 ml-12 gap-2"
            />
           <span className="text-2xl font-semibold hover:text-indigo-500 -ml-4">AI Sphere</span>
          </div>
        ...
        <ul className="hidden md:flex items-center gap-8 text-2xl hover:text-indigo-500">
          <li>
            <Link href="/">Home</Link>
          </li>
          <li>
